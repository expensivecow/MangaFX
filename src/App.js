...
class App extends Component {
  configuration = {
    ...
    soundEffectConfig: [
      ...
      {id: 3, soundEffects: [{id: 0, url: 'https://raw.githubusercontent.com/expensivecow/ImageAndSoundRepo/master/SoundEffects/WowMeme.mp3', volume: 100, delay: 5000}, {id: 1, url: 'https://github.com/expensivecow/ImageAndSoundRepo/raw/master/SoundEffects/HeavyPunch.wav', volume: 100, delay: 5}]},
      {id: 4, soundEffects: [{id: 0, url: '', volume: 100, delay: 5}, {id: 1, url: '', volume: 100, delay: 5}, {id: 2, url: '', volume: 100, delay: 5}]},
      {id: 5, soundEffects: [{id: 0, url: '', volume: 100, delay: 5}]},
      {id: 6, soundEffects: [{id: 0, url: '', volume: 100, delay: 5}]},
      {id: 7, soundEffects: [{id: 0, url: '', volume: 100, delay: 5}]},
      {id: 8, soundEffects: [{id: 0, url: '', volume: 100, delay: 5}]},
      {id: 9, soundEffects: [{id: 0, url: '', volume: 100, delay: 5}]},
      {id: 10, soundEffects: [{id: 0, url: '', volume: 100, delay: 5}]},
      {id: 11, soundEffects: [{id: 0, url: '', volume: 100, delay: 5}]},
      {id: 12, soundEffects: [{id: 0, url: '', volume: 100, delay: 5}]},
      {id: 13, soundEffects: [{id: 0, url: '', volume: 100, delay: 5}]},
      {id: 14, soundEffects: [{id: 0, url: '', volume: 100, delay: 5}]},
      {id: 15, soundEffects: [{id: 0, url: '', volume: 100, delay: 5}]},
      {id: 16, soundEffects: [{id: 0, url: '', volume: 100, delay: 5}]},
      {id: 17, soundEffects: [{id: 0, url: '', volume: 100, delay: 5}]},
      {id: 18, soundEffects: [{id: 0, url: '', volume: 100, delay: 5}]},
      {id: 19, soundEffects: [{id: 0, url: '', volume: 100, delay: 5}]},
      {id: 20, soundEffects: [{id: 0, url: '', volume: 100, delay: 5}]},
      {id: 21, soundEffects: [{id: 0, url: '', volume: 100, delay: 5}]},
      {id: 22, soundEffects: [{id: 0, url: '', volume: 100, delay: 5}]},
    ...
    backgroundMusicConfig: [
      {id: 2, music: {} },
      {id: 3, music: {url: 'https://raw.githubusercontent.com/expensivecow/ImageAndSoundRepo/master/BackgroundMusic/BecomeAHero.mp3', config: {volume: 100, delay: 0}} },
      {id: 4, music: {url: 'https://raw.githubusercontent.com/expensivecow/ImageAndSoundRepo/master/BackgroundMusic/BecomeAHero.mp3', config: {volume: 100, delay: 0}} },
      {id: 5, music: {url: 'https://raw.githubusercontent.com/expensivecow/ImageAndSoundRepo/master/BackgroundMusic/BecomeAHero.mp3', config: {volume: 100, delay: 0}} },
      {id: 6, music: {} },
      {id: 7, music: {} },
      {id: 8, music: {} },
      {id: 9, music: {} },
