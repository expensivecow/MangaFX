...
class App extends Component {
  configuration = {
    ...
    soundEffectConfig: [
      ...
      {id: 18, soundEffects: [{id: 0, url: 'https://raw.githubusercontent.com/expensivecow/ImageAndSoundRepo/master/SoundEffects/FemaleByeBye.mp3', volume: 50, delay: 5}]},
      {id: 19, soundEffects: [{id: 0, url: 'https://raw.githubusercontent.com/expensivecow/ImageAndSoundRepo/master/SoundEffects/WowMeme.mp3', volume: 25, delay: 5}]},
      {id: 20, soundEffects: [{id: 0, url: '', volume: 25, delay: 5}]},
      {id: 21, soundEffects: [{id: 0, url: '', volume: 100, delay: 5}]},
      {id: 22, soundEffects: [{id: 0, url: 'https://raw.githubusercontent.com/expensivecow/ImageAndSoundRepo/master/SoundEffects/Crickets.mp3', volume: 25, delay: 5}]},
